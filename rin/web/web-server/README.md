...
serving the static frontend from the package's web/ directory. It does not
...
| staticRoot | <package>/web | Static frontend directory. |
...
Static: GET / serves web/index.html; GET /<path> serves files under the static
root with path-traversal protection; anything else is 404. The web/ directory
is owned by the frontend package.

## Known Limitations and Deferred Work

- The web/ directory is owned by a separate frontend package; this plugin only
