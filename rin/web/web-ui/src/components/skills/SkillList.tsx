...
const SOURCE_ACCENT_CLASS = 'bg-[var(--color-surface-container-high)] text-[var(--color-text-tertiary)]'
...
export function SkillList() {
  ...
  return (
    <div className="min-w-0 overflow-hidden rounded-[12px] border border-[var(--color-border)] bg-[var(--color-surface-container)]">
        ...
        {SOURCE_ORDER.map((source) => {
          ...
          return (
            <section
              ...
              className="min-w-0"
            >
              <div className="flex min-h-[48px] items-center justify-between gap-[16px] bg-[var(--color-surface-container-low)] px-[20px] py-[8px]">
                <div className="flex min-w-0 items-center gap-[8px]">
                  <span className={`inline-flex h-[24px] w-[24px] flex-shrink-0 items-center justify-center rounded-[6px] ${SOURCE_ACCENT_CLASS}`}>
                    <Icon name={SOURCE_ICONS[source]} size={13} />
                  </span>
                  <h4 className="truncate text-[12px] font-semibold text-[var(--color-text-primary)]">
                    {sourceLabel}
                  </h4>
                ...
                {group.map((skill) => {
                  ...
                  return (
                    <div
                      ...
                      className={`group flex min-h-[64px] w-full items-stretch transition-colors hover:bg-[var(--color-surface-hover)] ${
                    ...
                    >
                      <button
                        ...
                        className="flex min-w-0 flex-1 items-start gap-[12px] px-[20px] py-[12px] text-left focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-black/15 focus-visible:ring-inset disabled:cursor-default disabled:opacity-60 dark:focus-visible:ring-white/20"
                      >
                      ...
                      <div className={`flex flex-shrink-0 items-center gap-[8px] pr-[20px] ${isPending ? 'opacity-60' : ''}`}>
