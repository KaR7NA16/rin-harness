...
describe('MessageList nested tool calls', () => {
  ...
  it('renders empty-state prompts without the broken pixel mascot for a brand new session', () => {
    useChatStore.setState({
      sessions: {
        [ACTIVE_TAB]: makeSessionState({
          messages: [],
    ...
    expect(screen.getByText(/Send a message below/)).toBeTruthy()

    expect(container.querySelector('svg[viewBox="0 0 15 12"]')).toBeNull()
  })
})
