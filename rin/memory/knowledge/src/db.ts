/**
 * rin knowledge — SQLite adapter.
 *
 * Owns the SQLite schema, migrations, and connection opening for the knowledge
 * database, on Node's built-in node:sqlite (zero external dependencies).
 *
...
/** Open (creating on demand) the knowledge database and prepare its schema. */
...
/** Create the knowledge tables, indexes, and FTS indexes when absent. */
