/**
 * rin memory — canonical memory contracts.
 *
 * A memory item is an addressable, user-owned fact or projection reference.
 * The source and lifecycle fields are deliberately explicit so a search hit or
 * model-generated candidate cannot silently become an untraceable memory.
 *
 * @module @rin/memory
 */
