...
export function ModelSelector({
  ...
  const compactClassName = 'model-selector-compact h-[34px] max-w-[176px] rounded-full border border-[var(--color-border-separator)] bg-[var(--color-surface-container-high)] px-[12px] text-[12px] font-semibold leading-normal text-[var(--color-text-secondary)] hover:bg-[var(--color-surface-hover)] hover:text-[var(--color-text-primary)]'
  const compactLabelClassName = 'max-w-[118px]'
  ...
  return (
    <div ref={ref} className="relative">
      ...
      >
        ...
        <span title={buttonModelLabel} className={`min-w-0 truncate ${compact ? compactLabelClassName : 'flex-1 text-[14px] font-semibold text-[var(--color-text-primary)]'}`} style={compact ? undefined : { fontFamily: 'var(--font-headline)' }}>
          {buttonModelLabel}
        </span>
