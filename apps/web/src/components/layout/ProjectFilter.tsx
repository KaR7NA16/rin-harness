...
export const ProjectFilter = memo(function ProjectFilter({ variant = 'default' }: { variant?: 'default' | 'embedded' }) {
  ...
  const setSessionFilterScope = useSessionStore((s) => s.setSessionFilterScope)
        ...
        >
          <div className="max-h-[380px] overflow-y-auto py-2 px-1.5">
            ...
            {loading && projects.length === 0 ? (
              ...
              <div className="px-4 py-5 text-center text-[12px] text-[var(--color-text-tertiary)]">{t('sidebar.noProjects')}</div>
            ) : (
              <>
