        ...
        >
          ...
          <div className="mt-1 flex justify-end gap-2">
            ...
            <button
              ...
              className="flex h-9 items-center gap-2 rounded-[8px] bg-[var(--color-btn-primary-bg)] px-3 text-[12px] font-bold text-[var(--color-btn-primary-fg)] transition-opacity hover:bg-[var(--color-btn-primary-bg-hover)] hover:opacity-90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-brand)] disabled:cursor-default disabled:opacity-45"
            >
