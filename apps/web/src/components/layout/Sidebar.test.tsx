...
describe('Sidebar', () => {
  ...
  it('groups sessions by date when time grouping is selected', async () => {
    const nowSpy = vi.spyOn(Date, 'now').mockReturnValue(new Date('2026-06-19T12:00:00.000Z').getTime())
    const now = Date.now()
      ...
      sessions: [
        {
          ...
          lastMessage: 'recent transcript',
          createdAt: iso(now - 3600_000),
          modifiedAt: iso(now - 3600_000),
          messageCount: 1,
          projectPath: '-workspace-alpha',
          workDir: '/workspace/alpha',
          workDirExists: true,
        ...
        },
        {
          id: 'session-old',
          title: 'Old Session',
          lastMessage: 'old transcript',
          createdAt: iso(now - 31 * 24 * 3600_000),
          modifiedAt: iso(now - 31 * 24 * 3600_000),
          messageCount: 1,
          projectPath: '-workspace-beta',
          workDir: '/workspace/beta',
          workDirExists: true,
