...
import { RUNTIME_TRANSITION_STATUS_VERBS } from '../config/serverVerbs'
...
const TASK_POLL_INTERVAL_HIDDEN_MS = 5000
        ...
        <section className="relative flex min-w-0 flex-1 flex-col overflow-hidden">
          ...
          <div className="relative flex min-h-0 flex-1 flex-col overflow-hidden">
            {!isMemberSession && sessionState?.connectionState === 'disconnected' && (
              <div className="w-full shrink-0 px-[24px] py-2">
                <div data-chat-content-column className="mx-auto w-full max-w-[878px]">
                  <div className="inline-flex max-w-full items-center gap-2 rounded-[16px] border border-[var(--color-error)]/20 bg-[var(--color-error)]/5 px-3 py-1.5 text-[11px] text-[var(--color-error)]">
                    <Icon name="sync" size={12} className="shrink-0 animate-spin" />
                    <span className="truncate">{t('chat.disconnectedBanner')}</span>
                  </div>
                </div>
              </div>
            )}
            {!isMemberSession && session?.workDirExists === false && (
              <div className="w-full shrink-0 px-[24px] py-2">
                <div data-chat-content-column className="mx-auto w-full max-w-[878px]">
                  <div className="inline-flex max-w-full items-center gap-2 rounded-[16px] border border-[var(--color-warning)]/20 bg-[var(--color-warning)]/5 px-3 py-1.5 text-[11px] text-[var(--color-warning)]">
