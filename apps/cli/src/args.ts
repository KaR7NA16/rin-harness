...
const HELP_EXAMPLES = `
Examples:
  rin --profile web                          boot the web profile (same as: rin web)
  rin --profile headless "run the tests"     answer one task, print the result, and exit
  rin --profile tui --patch ./extra.yml      boot a custom profile with one extra overlay
  rin --profile tui --resume <session>       arguments after the launcher flags reach the app
  rin --profile web --help                   the web app's own flags and help
  rin plugin --profile tui add <package>     install a plugin into the tui profile
`
...
export function parseDshArgs(argv: readonly string[], version: string): DshInvocation {
  ...
  program
    ...
    .description('rin: boot a rin-harness profile — an ordered stack of plugin-bundle patch layers under your own overrides.')
    ...
    .argument('[args...]', 'arguments for the booted profile\'s app (see: rin --profile <name> --help)')
  ...
  web
    ...
    .passThroughOptions()
    .enablePositionalOptions()
    .argument('[args...]', 'arguments for the web app (see: rin web --help)')
    .option('--patch <path>', 'extra patch-list overlay applied after the profile layer (repeatable)', collect)
