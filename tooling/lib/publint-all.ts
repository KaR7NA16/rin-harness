/** Inspect the manifest-declared publication view of workspace packages. */
...
/** Manifest globs for the canonical apps/packages workspace tree. */
const WORKSPACE_GLOBS = [
  'apps/*/package.json',
  'packages/*/*/package.json',
] as const

/** Product-layer packages (desktop shell and web UI) publish no npm entry points. */
const RIN_PRODUCT_LAYER = new Set([
  'apps/desktop',
  'apps/web',
])
...
/**
 * Discover publish targets matching the given manifest globs, skipping product
 * layer entries that have no npm publication view.
