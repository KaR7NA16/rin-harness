 ...
 * reject) reads and mutates real @rin/memory/skill data instead of 404/empty
 * stubs. Returns null for any pathname it does not claim.
 *
 * This module carries no runtime dependency on @rin/memory/skill (web-server
...
/** The skill-memory directory name under a config root (mirrors @rin/memory/skill). */
const SKILL_MEMORY_DIRNAME = 'skill-memory'
/** The per-skill stats sidecar file name (mirrors @rin/memory/skill). */
const SKILL_MEMORY_STATS_FILENAME = 'STATS.json'
/** The per-skill summary file name (mirrors @rin/memory/skill). */
