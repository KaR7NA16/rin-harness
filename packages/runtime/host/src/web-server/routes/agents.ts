 ...
 * over ctx.rinAgents. All @rin/workspace/agents imports are type-only, so this
...
import type { AgentPermissionMode } from '@rin/assets'
import type { RepositoryAgentInput, RepositoryAgentUpdateInput } from '@rin/workspace/agents'
