 ...
 *
 * Asserts the @rin/host roster is complete and correctly scoped: all
 * the @rin host plugins plus the web-server, dsh-base first, and
 * dsh-web-app absent (docs/archive/migration/MIGRATION.md §8 decision 10). Pure data assertions — no
 * Cordis boot.
 *
...
if (RIN_WEB_SERVER !== '@rin/host/web-server') throw new Error('RIN_WEB_SERVER mismatch')
