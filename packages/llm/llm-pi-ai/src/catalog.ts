...
/**
 * pi-ai thinking formats a profile cannot name: they drive the request through
 * template arguments this configuration does not expose (`chatTemplateKwargs`
 * for `chat-template`/`qwen-chat-template`, `chatTemplateArgs` for `baseten`).
 */
