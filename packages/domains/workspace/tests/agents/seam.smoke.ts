...
import { createRepositoryAgent, updateRepositoryAgent } from '../../src/agents/repository-agents.ts'
import { AUTO_PROJECT_EVENT, computeRepositoryFingerprint, registerAgentsSeam } from '../../src/agents/seam.ts'
import { COMPOSITION_FILE } from '../../src/agents/projection.ts'
