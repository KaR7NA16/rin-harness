 ...
 *
 * @rin/workspace/agents bridges the asset repository's agent records and the dsh
...
import type { AgentPermissionMode, RepositoryAgentConfiguration } from '@rin/assets'
