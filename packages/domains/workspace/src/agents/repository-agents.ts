 ...
 * agents/ root, using the same file convention @rin/assets's reader
 ...
 * type-only references into @rin/assets.
 *
...
/** The repository manifest file name, mirroring @rin/assets. */
 ...
 *
 * Mirrors @rin/assets's root resolution: the manifest's `spec.roots.agents`
...
/** Parse and validate one AgentConfiguration document, mirroring @rin/assets's reader. */
