 ...
 * @rin/assets and @rin/workspace/environment are re-exported so the whole seam
 * resolves from one module.
 *
 * @module @rin/workspace/sandboxes
 */

import type { ResolvedEnvironmentPlan, ResolverCapabilities } from '@rin/assets'
import type { InstallRun, StageExecutionResult } from '@rin/workspace/environment'
